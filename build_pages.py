...
def build_pages():
    ...
    with open('README.md', 'w') as f:
        ...
        f.write("Generated by `build_pages.py`; newest first. "
        ...
        for category in ordered_categories:
            ...
            f.write(f"<details>\n<summary><b>{category}</b> ({len(cat_papers)})</summary>\n\n")
            f.write(f"On the site: [{category}]({SITE_URL}{listing_url(topic_folder(category))})\n\n")
